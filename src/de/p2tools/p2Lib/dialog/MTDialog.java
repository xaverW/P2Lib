...
public class MTDialog {
    ...
    public MTDialog(String fxml, PConfData conf, String title, boolean modal) {
        this.fxml = fxml;
        this.conf = conf;
        this.modal = modal;
        this.title = title;
    ...
    public MTDialog(PConfData conf, String title, boolean modal) {
        this.fxml = null;
        this.conf = conf;
        this.modal = modal;
        this.title = title;
    ...
    public void showDialog() {
        ...
        if (conf != null) {
            ...
            Stage parentStage = PConst.primaryStage;
            if (parentStage != null) {
