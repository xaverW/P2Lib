...
public class PConfDataColor {
    ...
    public PConfDataColor(PConfData pConfData, Color color, String text) {
        this.setpConfData(pConfData);
        setText(text);
        setColor(color);
        setColorReset(color);
    }
    ...
    public PConfData getPConfData() {
        return pConfData;
    }

    public void setpConfData(PConfData pConfData) {
        this.pConfData = pConfData;
    }
