...
public class P2ColorData extends P2ColorDataProps {
    ...
    public String getColorSelectedToWeb() {
        return "#" + P2ColorFactory.getColorToHex(dark ? getColorDark() : getColorLight());
    }

    public String getColorSelectedToWeb(boolean odd) {
        if (odd) {
            return "#" + P2ColorFactory.getColorToHex(getColorOdd(dark ? getColorDark() : getColorLight()));
        } else {
            return "#" + P2ColorFactory.getColorToHex(dark ? getColorDark() : getColorLight());
        }
    }
    ...
    public String getColorLightToWeb() {
        return "#" + P2ColorFactory.getColorToHex(getColorLight());
    }

    public String getColorDarkToWeb() {
        return "#" + P2ColorFactory.getColorToHex(getColorDark());
    }

    public String getColorDarkerToWeb() {
        return "#" + P2ColorFactory.getColorToHex(dark ? getBrighterColor(getColorDark()) : getDarkerColor(getColorLight()));
    }
