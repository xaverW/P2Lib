...
public class P2TextFieldInteger extends TextField {
    ...
    public P2TextFieldInteger() {
    }

    public P2TextFieldInteger(boolean stateLabel) {
        this.stateLabel = stateLabel;
        setStateLabel();
    }

    public P2TextFieldInteger(IntegerProperty integerProperty) {
        this.integerProperty = integerProperty;
        bindBidirectional();
    }

    public P2TextFieldInteger(IntegerProperty integerProperty, boolean stateLabel) {
        this.integerProperty = integerProperty;
        this.stateLabel = stateLabel;
        setStateLabel();
        bindBidirectional();
    ...
    private void bindBidirectional() {
        ...
        Bindings.bindBidirectional(textProperty(), integerProperty, new P2NumberStringConverter(this, stateLabel));
