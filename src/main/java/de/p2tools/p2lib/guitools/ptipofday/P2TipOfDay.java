...
public class P2TipOfDay {
    ...
    public P2TipOfDay(String text, String image) {
        this.text = text;
        this.image = image;
    ...
    public P2TipOfDay(String text, String image, String pHyperlink, StringProperty openUrlWithProg) {
        this.text = text;
        this.image = image;
    ...
    public static P2TipOfDay getTipWebsite(StringProperty progOpenUrl) {
