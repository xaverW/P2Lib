...
public class P2TextFieldMoney extends TextField {
...
//    }
    ...
    private void setLabelLike() {
        ...
        setStyle(labelLike ? P2Styles.PTEXTFIELD_LABEL : "");
    }
        ...
        Bindings.bindBidirectional(textProperty(), doubleProperty, new NumberStringConverter(DF) {
            ...
            public Number fromString(String value) {
                ...
                try {
                    ...
                    ret = P2TextFieldMoney.NF.parse(value);
...
//    }
    ...
    private void setTextStyle(String value) {
        ...
        try {
            ...
            setStyle(labelLike ? P2Styles.PTEXTFIELD_LABEL_ERROR : P2Styles.PTEXTFIELD_ERROR);
        }
    }
}
