...
public class P2CboButtonListString extends ComboBox<P2CboButtonListString.PCboLabel> {
    ...
    public P2CboButtonListString(ObservableList<String> storedFilterList, StringProperty strSearchProperty) {
    ...
    public P2CboButtonListString(ObservableList<String> storedFilterList,
