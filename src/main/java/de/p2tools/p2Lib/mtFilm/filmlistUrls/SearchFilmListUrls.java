...
public class SearchFilmListUrls {
    ...
    public String getFilmlistUrlForCompleteList(String userAgent) {
        return getFilmlistUrlForCompleteList(null, userAgent);
    }

    public String getFilmlistUrlForCompleteList(ArrayList<String> alreadyTried, String userAgent) {
    ...
    public String getFilmlistUrlForDiffList(String userAgent) {
        return getFilmlistUrlForDiffList(null, userAgent);
    }

    public String getFilmlistUrlForDiffList(ArrayList<String> alreadyTried, String userAgent) {
        // passende URL zum Laden der Filmliste suchen
        updateFilmlistDownloadUrls(userAgent);
    ...
    private void updateFilmlistDownloadUrls(String userAgent) {
        ...
        if (updateFilmlistUrls || filmlistUrlList_akt.isEmpty() || filmlistUrlList_diff.isEmpty()) {
            ...
            updateDownloadUrlsForFilmlists(userAgent);
     ...
     **/
    public void updateDownloadUrlsForFilmlists(String userAgent) {
        ...
        getDownloadUrlsForFilmlists(LoadFactoryConst.ADRESSE_FILMLISTEN_SERVER_AKT, tmp,
                userAgent, FilmlistUrlData.SERVER_TYPE_ACT);
        ...
        tmp.clear();
        getDownloadUrlsForFilmlists(LoadFactoryConst.ADRESSE_FILMLISTEN_SERVER_DIFF, tmp,
                userAgent, FilmlistUrlData.SERVER_TYPE_DIFF);
