...
public abstract class ConfigExtra_pFileSize extends ConfigExtra {

    private PFileSize actValue;

    public ConfigExtra_pFileSize(String key, PFileSize actValue) {
        super(key);
        this.actValue = actValue;
    }

    public ConfigExtra_pFileSize(String key, String name, PFileSize actValue) {
        super(key, name);
        this.actValue = actValue;
    }
