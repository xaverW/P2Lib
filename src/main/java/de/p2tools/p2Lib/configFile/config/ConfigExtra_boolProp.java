...
public class ConfigExtra_boolProp extends ConfigExtra {

    private BooleanProperty actValue;

    public ConfigExtra_boolProp(String key, BooleanProperty actValue) {
        super(key);
        this.actValue = actValue;
    }

    public ConfigExtra_boolProp(String key, String name, BooleanProperty actValue) {
        super(key, name);
        this.actValue = actValue;
    }
