...
public class ConfigExtra_longProp extends ConfigExtra {

    private LongProperty actValue;

    public ConfigExtra_longProp(String key, LongProperty actValue) {
        super(key);
        this.actValue = actValue;
    }

    public ConfigExtra_longProp(String key, String name, LongProperty actValue) {
        super(key, name);
        this.actValue = actValue;
    }
