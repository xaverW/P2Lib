...
public class ConfigMoneyPropExtra extends ConfigExtra {

    private LongProperty actValue;
    private boolean onlyLabel = false;

    public ConfigMoneyPropExtra(String key, String name, LongProperty actValue) {
        super(key, name);
        this.actValue = actValue;
    }

    public ConfigMoneyPropExtra(String key, String name, LongProperty actValue, boolean onlyLabel) {
        super(key, name);
        this.actValue = actValue;
